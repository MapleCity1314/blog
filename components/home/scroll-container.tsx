...
export default function ScrollContainer({ posts, frames, resources }: ScrollContainerProps) {
  ...
  return (
    ...
    >
      <AmbientBackground />
      <GhostActor scrollProgress={smoothProgress} initialFrames={frames} />
      <HeroSection scrollProgress={smoothProgress} />
      <PostsSection posts={posts} scrollProgress={smoothProgress} />
      <ProjectsSection scrollProgress={smoothProgress} resources={resources} />
